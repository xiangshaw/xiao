package plus.axz.admin.gateway.utils;
...
public class JwtUtil {
    // TOKEN的有效期一天（S）
    private static final int TOKEN_TIME_OUT = 3600000;// 60 * 60 *1000  一个小时
    // 加密KEY
...
/*        Map map = new HashMap();
        map.put("id","1");
        System.out.println(JwtUtil.getToken(1L));//生成带id的jwt字符串*/
        // 解析生成的jwt字符串
